...
/* Scarab includes - uncomment these when integrating with Scarab */
// #define SCARAB_TYPES
// #include "globals/global_types.h"
// #include "globals/global_defs.h"
// #include "globals/utils.h"

/* Parameter variables - these will be overwritten by Scarab's param system */
uns PERCEPTRON_HIST_LEN = 28;
uns PERCEPTRON_TABLE_BITS = 7;
Flag BP_PERCEPTRON_ON = TRUE;

/***************************************************************************
 * External Parameters (defined in bp.param.def or PARAMS.in)
 * 
 * You'll need to add these to Scarab's parameter system:
 *   PERCEPTRON_HIST_LEN  - History length (default: 28 for 4KB budget)
 *   PERCEPTRON_TABLE_BITS - log2(number of perceptrons) (default: 7)
 ***************************************************************************/

/* Fallback defaults if params not defined */
#ifndef PERCEPTRON_HIST_LEN
#define PERCEPTRON_HIST_LEN 28
#endif

#ifndef PERCEPTRON_TABLE_BITS  
#define PERCEPTRON_TABLE_BITS 7
#endif
